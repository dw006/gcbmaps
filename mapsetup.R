...
kon <- read.csv(file.choose(), dec = ".", na.strings = "NA", sep = ";", header = TRUE, stringsAsFactors = FALSE)
...
konvergenz$Konvergenz <- factor(konvergenz$Konvergenz,
                                labels = c("Konvergenz", "Wettbewerbsfähigkeit & \nBeschäftigung"))
